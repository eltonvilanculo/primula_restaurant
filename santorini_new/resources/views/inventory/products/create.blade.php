                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('products.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">informação do produto</h6>
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('stock_defective') ? ' has-danger' : '' }}">
                                            <label class="form-control-label" for="input-stock_defective"> Stock mínimo</label>
                                            <input type="number" name="stock_defective" id="input-stock_defective" class="form-control form-control-alternative" placeholder="Stock mínimo" value="{{ old('stock_defective') }}" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" step=".01" name="price" id="input-price" class="form-control form-control-alternative" placeholder="Preço" value="{{ old('price') }}" required>
