...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    <h5 class="card-category">Produtividade do mês passado</h5>
                    <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i> @money($semesterincomes)</h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-bank text-info"></i> @money($monthlybalance) </h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    <h5 class="card-category">Despesas do último mês</h5>
                    <h3 class="card-title"><i class="tim-icons icon-paper text-success"></i> @money($semesterexpenses) </h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
                            ...
                            <tbody>
                                @foreach ($unfinishedsales as $sale)
                                    <tr>
                                        ...
                                        <td>@money($sale->transactions->sum('amount')) </td>
